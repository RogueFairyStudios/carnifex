...
find_path(CURL_INCLUDE_DIR curl/curl.h
	...
	PATHS ${CURL_PATH} "${CMAKE_CURRENT_SOURCE_DIR}/platforms/Windows/curl"
	NO_DEFAULT_PATH)
...
#Look in the bundled copy (or CURL_PATH) first, so that an unrelated libcurl
#that happens to be on PATH doesn't get picked over the headers we ship
...
find_file(ZLIB1_DLL names zlib1.dll PATHS ${CMAKE_CURRENT_SOURCE_DIR}/platforms/Windows/zlib PATH_SUFFIXES ${CURL_LIB_PATH})
